...
export interface ApiOrderRowOrderRow extends Struct.CollectionTypeSchema {
  collectionName: 'order_rows';
  info: {
    description: '';
    displayName: 'OrderRow';
    pluralName: 'order-rows';
    singularName: 'order-row';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    totalTaxes: Schema.Attribute.Decimal;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::order-row.order-row': ApiOrderRowOrderRow;
